...
function update(player) {
    ...
    if (player< 0){
        console.log(player.name, " player.x < 0")
        player.x = 0;
    } else if (player < 0) {
        console.log(player.name, "player.y < 0")
        player.y = 0;
    }
    // } else if (player.sprite.x + player.sprite.width > this.currentScene.gameWidth){
    //     console.log(player.name, "player.x + player.width > this.gameWidth")
    //     console.log(this.currentScene.gameWidth,  "this.gameWidth")
    //     player.sprite.x = this.currentScene.gameWidth - player.sprite.width;
    // } else if (player.sprite.y + player.sprite.height > this.currentScene.gameHeight) {
    //     console.log(player.name, "player.y + player.height > this.gameHeight")
    //     console.log(this.currentScene.gameHeight, " gameHeight")
    //     player.sprite.y = this.currentScene.gameHeight - player.sprite.height;
    // } 
}
